class SocialGroupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @social_group.save
        format.html { redirect_to @social_group, notice: "Social group was successfully created." }
  ...
  def update
    respond_to do |format|
      if @social_group.update(social_group_params)
        format.html { redirect_to @social_group, notice: "Social group was successfully updated." }
  ...
  private
    ...
    def social_group_params
      params.require(:social_group).permit(:name, :user_id)
    end
end
